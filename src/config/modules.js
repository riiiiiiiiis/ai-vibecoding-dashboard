...
export function getTermsByModule(moduleKey) {
  if (moduleKey === "basics") {
    return [
      { title: "Искусственный интеллект (ИИ)", desc: "Общий термин для систем, выполняющих интеллектуальные задачи: анализ, генерация, планирование." },
      ...
      { title: "Пользовательский интерфейс (UI)", desc: "Визуальная часть приложения: элементы, кнопки, формы, тексты." },
